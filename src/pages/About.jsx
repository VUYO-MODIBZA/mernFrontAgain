            ...
            <div className="about-page-content">
                ...
                <div className="about-page-cta">
                    <div className="image-container">
                        <img className="home-image1" src="https://res.cloudinary.com/dhcsne1pn/image/upload/v1743956313/family-tree/Imvelaphi%20ka%20Chitha%20Mthimba.png" alt="Family-tree" />
                        <img className="home-image2" src="https://res.cloudinary.com/dhcsne1pn/image/upload/v1744360466/family-tree/Copy_of_Neutral_Beige_Minimalist_Corporate_Company_Organizational_Chart_d1xvyr.png" />
